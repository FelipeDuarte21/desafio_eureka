package com.cooperfilme.api.controller.exception;
...
public class ResourceExceptionHandler extends ResponseEntityExceptionHandler{
	...
	@ExceptionHandler(ObjectNotContentException.class)
	public ResponseEntity<ErrorModel> notContentExceptionHandler(ObjectNotContentException ex,
			HttpServletRequest request){
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
		...
		ErrorArgument ea = new ErrorArgument(status.value(),((HttpStatus) status).getReasonPhrase(),"Erro de Validação!");
		ea.setErrors(errors);
